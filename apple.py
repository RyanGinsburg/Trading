...
def data(stock, start_date='2019-10-14 00:00:00', end_date=datetime.now(), technical_indicators):
    if technical_indicators:
        #TODO
    else:
        #TODO
    url = f'https://financialmodelingprep.com/api/v3/technical_indicator/1day/{stock}?type=rsi&period=1300&apikey={api_token}'
...
stock_data = data(stock, start_date, end_date, technical_indicators=True)
